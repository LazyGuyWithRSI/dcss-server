...
curl -o docker-compose.yml https://raw.githubusercontent.com/LazyGuyWithRSI/dcss-server/develop/server/docker-compose.yml && \
...
docker compose down && docker rmi LazyGuyWithRSI/dcss-server || true && \
